      ...
      <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
        <div className="max-w-2xl">
          <motion.span 
            ...
            className="text-accent text-sm font-mono tracking-[0.3em] uppercase mb-4 block"
          >
            Showcase
          </motion.span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {projects.map((project, index) => (
          <motion.div
            ...
            viewport={{ once: true }}
            className="group relative glass-card rounded-[2rem] overflow-hidden flex flex-col h-full hover:border-accent/30 transition-all duration-500"
          >
            {/* Project Header */}
            <div className="p-8 pb-0 flex justify-between items-start">
              ...
              {/* <div className="flex gap-2">
                <Link href={project.links.github} className="p-2 rounded-lg bg-white/5 border border-white/10 text-muted hover:text-accent transition-colors">
                  <Code className="w-4 h-4" />
                </Link>
                <Link href={project.links.live} className="p-2 rounded-lg bg-white/5 border border-white/10 text-muted hover:text-accent transition-colors">
